...
class WAQMSSeeder extends Seeder
{
    ...
    {
        $startDate = Carbon::create(2024, 8, 1, 0, 0, 0); // Mulai dari 2024-01-01 00:00:00
        $endDate = Carbon::create(2024, 8, 31, 23, 59, 0); // Akhir tahun 2024
        ...
        $chunks = array_chunk($data, 1000);
        foreach ($chunks as $chunk) {
            DB::table('waqms_raw')->insert($chunk);
        }
    }
}
