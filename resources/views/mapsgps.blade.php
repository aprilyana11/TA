      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-BBtl+eGJRgqQAUMxJ7pMwbE yER4l1g+O15P+16Ep7Q9Q+zqX6gSbd85u4mG4QzX+" crossorigin="anonymous"></script>
            <script>
              ...
              var initialMarker = L.marker([51.505, -0.09], {
                icon: redIcon
              });
              var updatedMarker = L.marker([51.505, -0.09], {
                icon: blueIcon
              });
              var finishMarker = L.marker([51.505, -0.09], {
                icon: greenIcon
              });
              ...
              var trackingHistory = [{
                  lat: 51.505,
                  lng: -0.09,
                  timestamp: "2023-06-10 10:00:00"
                },
                {
                  lat: 51.51,
                  lng: -0.1,
                  timestamp: "2023-06-10 10:05:00"
                },
                {
                  lat: 51.52,
                  lng: -0.12,
                  timestamp: "2023-06-10 10:10:00"
                },
                {
                  lat: 51.53,
                  lng: -0.13,
              ...
              function resetMap() {
                ...
                initialMarker = L.marker([51.505, -0.09], {
                  icon: redIcon
                });
                updatedMarker = L.marker([51.505, -0.09], {
                  icon: blueIcon
                });
                finishMarker = L.marker([51.505, -0.09], {
                  icon: greenIcon
                });
                polyline = L.polyline([], {
                  color: "blue"
